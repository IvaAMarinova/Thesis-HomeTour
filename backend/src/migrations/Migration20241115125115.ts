...
export class Migration20241115125115 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "user_property" drop constraint "user_property_user_id_unique";`);
    this.addSql(`alter table "user_property" drop constraint "user_property_property_id_unique";`);
  }
