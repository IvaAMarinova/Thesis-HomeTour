  ...
  return (
    <div className="pt-16">
      <div className="w-full max-w-7xl mt-16 mx-auto px-4 mb-16">
        <h1 className="text-3xl text-center font-bold text-gray-800 mb-12">
          Нашите партньори
        </h1>
        <h2 className="text-xl text-center text-gray-700 mb-12">
          Разгледайте компаниите строители и наши партньори. <br />
          Свържете се с тях, за да предприемете следващите стъпки по
          закупуването на вашия нов дом!
        </h2>
        {companies.length === 0 ? (
          <div className="flex items-center justify-center h-20">
            <p className="text-center text-gray-700">
              За момента нямаме компании, които да ви покажем. Пробвайте пак
              по-късно!
            </p>
          </div>
        ) : (
