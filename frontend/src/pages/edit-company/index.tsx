      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <div className="text-center space-y-4">
          <p className="text-xl font-bold">
            В момента не можем да визуализираме тази компания.
          </p>
    ...
    <div className="pt-16 align-middle flex flex-col items-center">
      <div className="relative p-9 w-full max-w-6xl mx-auto lg:border rounded-lg lg:mt-14">
        ...
        <div className="space-y-6 mt-12">
          ...
          company.resources.galleryImage.url ? (
            <EditSingleImage
              image={company.resources.galleryImage}
              type={"gallery"}
              handleDeleteImage={handleDeleteImage}
            />
          ) : (
