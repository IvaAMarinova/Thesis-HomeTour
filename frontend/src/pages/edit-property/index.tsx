...
function EditProperty() {
  ...
  const handleUpdateProperty = async () => {
    try {
      ...
      const response = await HttpService[method]<Property>(
        url,
        updatedProperty,
        undefined,
        true,
      ...
      toast.success(
        isNewProperty
          ? "Имотът беше успешно създаден!"
          : "Имотът беше успешно обновен!",
      );
      setLocalImages({});
      setImagesToDelete([]);
      setPropertySaved(true);
      ...
      <div className="relative p-9 w-full max-w-6xl mx-auto rounded-lg lg:mt-14">
        ...
        <div className="space-y-6 mt-12">
          <EditPropertyText
            ...
            setPropertySaved={setPropertySaved}
          />
          <EditPropertyAddress
            property={property}
            setProperty={setProperty}
          ...
          property.resources.headerImage.url ? (
            <EditSingleImage
              image={property.resources?.headerImage}
              type={"header"}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {property.resources.galleryImages?.map(
